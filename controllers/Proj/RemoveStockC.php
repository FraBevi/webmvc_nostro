...
use models\Proj\RemoveStockM as RemoveStockModel;
use views\Proj\RemoveStockV  as RemoveStockView;
...
class RemoveStockC extends Controller
{
    protected $view;
    protected $model;
    ...
    protected function autorun($parameters = null)
    {
        ...
        $historyBack = $record->getControllerHistoryBack("remove_stock_c");
    ...
    {
        $view = new RemoveStockView("/proj/remove_stock");
        return $view;
    }
