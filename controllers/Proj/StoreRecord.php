...
use models\Proj\StoreRecord as PartRecordModel;
...
class StoreRecord extends Controller
{
    protected $view;
    protected $model;
    ...
    */
    protected function autorun($parameters = null)
    {
        ...
        $historyBack = $record->getControllerHistoryBack("part_in_store_c");
    ...
    */
    ...
    {
        $view = new PartRecordView("/proj/store_record");
        return $view;
    }
