...
use models\Proj\RemoveMovementM as RemoveMovementModel;
use views\Proj\RemoveMovementV  as RemoveMovementView;
...
class RemoveMovementC extends Controller
{
    protected $view;
    protected $model;
    ...
    protected function autorun($parameters = null)
    {
        ...
        $historyBack = $record->getControllerHistoryBack("RemoveMovementC");
    ...
    {
        $view = new RemoveMovementView("/proj/remove_movement");
        return $view;
    }
